...
A property management system built with React and TypeScript.
It allows landlords to manage tenants, properties, and payments,
and provides tenants with dashboards to view and manage their tenancy.
...
Ensure code follows the existing structure and naming conventions.
